...
import static xyz.tynn.astring.example.common.AStringsKt.getAString;
import static xyz.tynn.astring.example.common.AStringsKt.getAccessibilityPaneTitle;
import static xyz.tynn.astring.example.common.AStringsKt.getAction1;
import static xyz.tynn.astring.example.common.AStringsKt.getAction2;
import static xyz.tynn.astring.example.common.AStringsKt.getAction3;
import static xyz.tynn.astring.example.common.AStringsKt.getAppend;
import static xyz.tynn.astring.example.common.AStringsKt.getAppendRange;
import static xyz.tynn.astring.example.common.AStringsKt.getContentDescription;
import static xyz.tynn.astring.example.common.AStringsKt.getDialog;
import static xyz.tynn.astring.example.common.AStringsKt.getError;
import static xyz.tynn.astring.example.common.AStringsKt.getErrorIcon;
import static xyz.tynn.astring.example.common.AStringsKt.getHint;
import static xyz.tynn.astring.example.common.AStringsKt.getMessage;
import static xyz.tynn.astring.example.common.AStringsKt.getStateDescription;
import static xyz.tynn.astring.example.common.AStringsKt.getTextType;
import static xyz.tynn.astring.example.common.AStringsKt.getTooltipText;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupDialogs(ActivityMainBinding binding) {
        ...
        binding.buttonToastUpdate.setOnClickListener(v -> {
            ...
            AStringToast.setText(t, this, getDialog());
            t.show();
        });
    }
